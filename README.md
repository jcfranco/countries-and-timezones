...
```html
<!-- Latest version -->
<script src="https://cdn.jsdelivr.net/npm/countries-and-timezones@latest/dist/index.min.js" type="text/javascript"></script>

<!-- Or specify a version -->
<script src="https://cdn.jsdelivr.net/npm/countries-and-timezones@v3.7.0/dist/index.min.js" type="text/javascript"></script>
